...
#****** CERTIFICADOS *******
    ...
    def action_cfdi_nomina_generate(self):
        for payslip in self:
            ...
            if json_response.get('factura_xml'):
                ...
                report = self.env['ir.actions.report']._get_report_from_name('nomina_mx.report_payslip')
    ...
    def send_nomina(self):
        self.ensure_one()
        template = self.env.ref('nomina_mx.email_template_payroll', False)
...
class MailTemplate(models.Model):
    ...
    def generate_email(self, res_ids, fields=None):
        ...
        template_id = self.env.ref('nomina_mx.email_template_payroll')
